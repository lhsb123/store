<script src="../../../vue2.x实战项目/06.Vue2.0+Node.js+MongoDB全栈打造商城系统/代码/v18dyy/server/bin/www"></script>
<script src="../../../vue2.x实战项目/06.Vue2.0+Node.js+MongoDB全栈打造商城系统/z1b8jp/server/app.js"></script>
<template>
  <div>
